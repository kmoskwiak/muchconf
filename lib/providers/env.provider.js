...
var EnvProvider = /** @class */ (function (_super) {
    __extends(EnvProvider, _super);
    function EnvProvider(configMap, options) {
    ...
    EnvProvider.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readEnv()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    EnvProvider.prototype.readEnv = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, map(this.config, this.configMap, function (envName) {
                            var value = _this.parse(process.env[envName]);
                            return value;
                        })];
                    case 1:
                        _a.sent();
    ...
    EnvProvider.prototype.load = function () {
