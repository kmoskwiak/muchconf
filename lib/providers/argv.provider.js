...
var parseArgv = require('../utils/parse-argv');
var ArgvProvider = /** @class */ (function (_super) {
    __extends(ArgvProvider, _super);
    function ArgvProvider(configMap, options) {
    ...
    ArgvProvider.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readArgv(process.argv)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ArgvProvider.prototype.readArgv = function (argv) {
        return __awaiter(this, void 0, void 0, function () {
            var argvConfig;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        argvConfig = parseArgv(argv);
                        return [4 /*yield*/, map(this.config, this.configMap, function (argName) {
                                var value = _this.parse(argvConfig[argName]);
                                return value;
                            })];
                    case 1:
                        _a.sent();
    ...
    ArgvProvider.prototype.load = function () {
