...
var FileProvider = /** @class */ (function (_super) {
    __extends(FileProvider, _super);
    function FileProvider(configMap, options) {
        var _this = _super.call(this) || this;
        var defaultOptions = {
            fromEnv: false
        };
        _this.setOptions(__assign(__assign({}, defaultOptions), options));
        _this.configMap = configMap;
        _this.config = {};
        return _this;
    }
    ...
    FileProvider.prototype.readFile = function (filePath) {
    ...
    FileProvider.prototype.readConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, map(this.config, this.configMap, function (filePath) { return __awaiter(_this, void 0, void 0, function () {
                            var value, _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        if (!this.options.fromEnv) return [3 /*break*/, 2];
                                        return [4 /*yield*/, this.readFile(process.env[filePath])];
                                    case 1:
                                        _a = _b.sent();
                                        return [3 /*break*/, 4];
                                    case 2: return [4 /*yield*/, this.readFile(filePath)];
                                    case 3:
                                        _a = _b.sent();
                                        _b.label = 4;
                                    case 4:
    ...
    FileProvider.prototype.load = function () {
